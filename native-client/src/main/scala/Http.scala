...
case class MultiPart(name: String, filename: String, mime: String, data: InputStream, numBytes: Long, writeCallBack: Long => Unit)

case class HttpException(code: Int, message: String, body: String, cause: Throwable) extends
